# (My Fork) Lancache Monolithic for ARM32/ARM64

![Docker Pulls](https://img.shields.io/docker/pulls/boyphongsakorn/lancachenet-monolithic?label=Monolithic) ![Docker Pulls](https://img.shields.io/docker/pulls/boyphongsakorn/lancachenet-lancache-dns?label=Lancache-dns) ![Docker Pulls](https://img.shields.io/docker/pulls/boyphongsakorn/lancachenet-sniproxy?label=Sniproxy) ![Docker Pulls](https://img.shields.io/docker/pulls/boyphongsakorn/lancachenet-generic?label=Generic)
...
- To install:
  ...
  - `sudo git clone https://github.com/boyphongsakorn/lancache-rpi.git`
  - `cd lancache-rpi`
  - `nano .env`
...
# (Original) Lancache Monolithic for ARM32/ARM64
